    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-navy-900 px-4 py-10">
      ...
      <div className="animate-page relative w-full max-w-sm">
        <div className="mb-8 text-center text-white">
          <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-lg font-bold text-brand-orange shadow-lg shadow-black/20">
            $
          </div>
        ...
        <div className="rounded-3xl bg-white p-6 shadow-2xl">{children}</div>
      </div>
    </div>
  );
}
